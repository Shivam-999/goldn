      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav ">
          <li class="nav-item active">
           ...
           <li class="nav-item active">
            <a class="nav-link" href="team.html">Who are we? <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item active">
        ...
        <li class="nav-item active">
         <a class="nav-link" href="signup.php">Sign up <span class="sr-only">(current)</span></a>
          ...
          <li class="nav-item">
            <a class="nav-link" href="#"  data-toggle="modal" data-target="#staticBackdrop">Sign in</a>
    ...
    <div class="modal-dialog modal-size">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="staticBackdropLabel">GOLDN BYRD</h4>
        ...
        <div class="modal-body">
            ...
            <div class="signup-form">
                ...
                <div class="form-group">
                        <button type="submit" name ="log_in" class="btn btn-success btn-lg signup-btn">Sign In</button>
                    </div>
                </form>
            </div>
            <!------------------->
...
<!--jumbotron-->
<div class="jumbotron jumbotron-fluid" style="height: 200px;background-image: url(img/black.png); background-size: cover;">
        <div class="container">
          <div class="row featurette">
            <div class="col-md-12">
              <h1 class="text-center display-4">Food</h1>
            </div>
            </div>
...
<br> <div class="row featurette">
  ...
  <p class="lead" align="justify">Unlearn your way of last minute mugging up book theories and cursing the course creators. Go through our professionally solved past year exam papers of your respective fields with easy to understand solutions and highlighted concepts. Relearn the art of timely learning with our support and knowledge. Let’s start with the smart work once again by reconnecting with the exam patterns and marking criteria!!</p>
    ...
    <!--jumbotron--> <br>
    <div class="jumbotron" style="height: 230px; background-color:#363636;">
            <div class="container">
              <div class="row featurette">
                <div class="col-md-3">
                  <h3 class="text-center display-4" style="color: white;"><i class="fas fa-university"></i> 100+ <span> <br> <h1>NGOs</h1>  </span> </h3>
                </div>
                <div class="col-md-3">
                  <h3 class="text-center display-4" style="color: white;"><i class="fas fa-user-friends"></i> 1000+ <span> <br> <h1>Donors</h1>  </span> </h3>
                </div>
                <div class="col-md-3">
                  <h3 class="text-center display-4" style="color: white;"><i class="fas fa-map-marker-alt"></i> 100+ <span> <br> <h1> Goal Set</h1> </span> </h3>
                </div>
                <div class="col-md-3">
                  <h3 class="text-center display-4" style="color: white;"><i class="fas fa-trophy"></i> 100+ <span> <br> <h1>Achieved</h1>  </span> </h3>
                </div>
                </div>
